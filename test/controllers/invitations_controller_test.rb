...
class InvitationsControllerTest < ActionController::TestCase
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post :create, invitation: { accept: @invitation.accept, email: @invitation.email, trip_id: @invitation.trip_id }
    end
  ...
  test "should update invitation" do
    patch :update, id: @invitation, invitation: { accept: @invitation.accept, email: @invitation.email, trip_id: @invitation.trip_id }
    assert_redirected_to invitation_path(assigns(:invitation))
  end
